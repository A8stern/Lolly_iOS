...
final class AdminViewController: UIViewController {
    ...
    private lazy var functionalSection: FuncSectionView = {
        let section = FuncSectionView()
        return section
    }()
...
extension AdminViewController: AdminView {
    func displayInitialData(viewModel: AdminModels.InitialData.ViewModel) {
        functionalSection.viewModel = viewModel.functionalSectionViewModel
...
extension AdminViewController: NavigationBarDelegate { }
